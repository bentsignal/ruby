...
export function useLocationSearch({
  ...
  // eslint-disable-next-line no-restricted-syntax -- The parent opens this controlled sheet directly, so the search session must follow that external open state.
  useEffect(() => {
